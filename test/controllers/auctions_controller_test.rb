...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { deadline: @auction.deadline, description: @auction.description, title: @auction.title } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { deadline: @auction.deadline, description: @auction.description, title: @auction.title } }
